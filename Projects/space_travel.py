...
if "I" not in user_list:   print("Although you might be able to survive without food for 3 days you will need your energy to drive the rover. You will not make it without food.")
